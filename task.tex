...
1.5 Доказать, что если $\vert z_1 \vert + \vert z_2 \vert + \vert z_3 \vert  = 0 $  и $\vert z_1 \vert = \vert z_2 \vert = \vert z_3 \vert= 1$, то точки $z_1, z_2, z_3$ являются вершинами правильного треугольника \\ \\
